...
/**
 * Fuegt bei SEPA-Sammelueberweisungen das Flag "Banktermin" hinzu.
 */
public class update0067 implements Update
{
  ...
  public update0067()
  {
    statements.put(DBSupportH2Impl.class.getName(),         "ALTER TABLE sepasueb ADD banktermin int(1) NULL;");
    statements.put(DBSupportMySqlImpl.class.getName(),      "ALTER TABLE sepasueb ADD banktermin int(10);");
    statements.put(DBSupportPostgreSQLImpl.class.getName(), "ALTER TABLE sepasueb ADD banktermin integer NULL;");
  }
  ...
  {
    return "Datenbank-Update für SEPA-Termin-Sammelüberweisungen";
  }
