...
/**
 * Erweitert die Tabelle "konto" um die Spalte "acctype"
 */
public class update0057 implements Update
{
  ...
  public update0057()
  {
    statements.put(DBSupportH2Impl.class.getName(),         "ALTER TABLE konto ADD acctype int(2) NULL;");
    statements.put(DBSupportMySqlImpl.class.getName(),      "ALTER TABLE konto ADD acctype int(2);");
    statements.put(DBSupportPostgreSQLImpl.class.getName(), "ALTER TABLE konto ADD acctype integer NULL;");
  }
  ...
  {
    return "Datenbank-Update für konfigurierbare Kontoart";
  }
