 ...
 */
public class update0055 implements Update
{
  ...
  public update0055()
  {
    statements.put(DBSupportH2Impl.class.getName(),         "ALTER TABLE aueberweisung ADD umbuchung int(1) NULL;");
    statements.put(DBSupportMySqlImpl.class.getName(),      "ALTER TABLE aueberweisung ADD umbuchung int(10);");
    statements.put(DBSupportPostgreSQLImpl.class.getName(), "ALTER TABLE aueberweisung ADD umbuchung integer NULL;");
  }
  ...
  {
    return "Datenbank-Update für SEPA-Umbuchungen";
  }
