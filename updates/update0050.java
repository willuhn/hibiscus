...
/**
 * Fuegt bei SEPA-Ueberweisungen das Flag "Banktermin" hinzu.
 */
public class update0050 implements Update
{
  ...
  public update0050()
  {
    statements.put(DBSupportH2Impl.class.getName(),         "ALTER TABLE aueberweisung ADD banktermin int(1) NULL;");
    statements.put(DBSupportMySqlImpl.class.getName(),      "ALTER TABLE aueberweisung ADD banktermin int(10);");
    statements.put(DBSupportPostgreSQLImpl.class.getName(), "ALTER TABLE aueberweisung ADD banktermin integer NULL;");
  }
  ...
  {
    return "Datenbank-Update für SEPA-Terminüberweisungen";
  }
