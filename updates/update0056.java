...
/**
 * Erweitert die Tabelle "konto" um die Spalte "backend_class"
 */
public class update0056 implements Update
{
  ...
  public update0056()
  {
    statements.put(DBSupportH2Impl.class.getName(),         "ALTER TABLE konto ADD backend_class varchar(1000);");
    statements.put(DBSupportMySqlImpl.class.getName(),      "ALTER TABLE konto ADD backend_class TEXT;");
    statements.put(DBSupportPostgreSQLImpl.class.getName(), "ALTER TABLE konto ADD backend_class varchar(1000);");
  }
  ...
  {
    return "Datenbank-Update für konfigurierbare Zugangsverfahren";
  }
