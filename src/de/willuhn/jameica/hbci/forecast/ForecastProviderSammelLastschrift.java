 ...
 */
public class ForecastProviderSammelLastschrift implements ForecastProvider
{
  ...
  public List<Value> getData(Konto k, Date from, Date to) throws Exception
  {
    ...
    while (list.hasNext())
    {
      SammelLastschrift l = (SammelLastschrift) list.next();
      result.add(new Value(l.getTermin(), l.getSumme()));
    }
    return result;
  }
}
