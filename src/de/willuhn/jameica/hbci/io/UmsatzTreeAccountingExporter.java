...
public class UmsatzTreeAccountingExporter extends AbstractUmsatzTreeExporter
{
  ...
  public void doExport(Object[] objects, IOFormat format, OutputStream os, ProgressMonitor monitor) throws RemoteException, ApplicationException
  {
    ...
    try
    {
      ...
      reporter.addHeaderColumn(i18n.tr("Einnahmen"), Element.ALIGN_CENTER, 30,  Reporter.COLOR_BG);
      reporter.addHeaderColumn(i18n.tr("Ausgaben"),  Element.ALIGN_CENTER, 30,  Reporter.COLOR_BG);
