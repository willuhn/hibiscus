...
public class HBCI extends AbstractPlugin
{
  ...
  private final static String HBCI4JAVA_VERSION = "3.1.82";
  ...
  public final synchronized void initHBCI(String callbackClass) throws ApplicationException
  {
    ...
    try
    {
      ...
      Feature.PINTAN_DECOUPLED_REFRESH.setEnabled(false); // Wir machen kein automatisches Refresh. Daf¸r haben wir ja den PushTAN-Dialog
