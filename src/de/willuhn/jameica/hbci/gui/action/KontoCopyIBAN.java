 ...
 */
public class KontoCopyIBAN implements Action
{
  ...
  public void handleAction(Object context) throws ApplicationException
  {
    ...
    try
    {
      String text = StringUtils.deleteWhitespace(k.getIban());
      
      final Clipboard cb = new Clipboard(GUI.getDisplay());
      cb.setContents(new Object[]{text}, new Transfer[]{TextTransfer.getInstance()});
      Application.getMessagingFactory().sendMessage(new StatusBarMessage(Application.getI18n().tr("IBAN in Zwischenablage kopiert."),StatusBarMessage.TYPE_SUCCESS));
    }
    catch (Exception e)
    {
