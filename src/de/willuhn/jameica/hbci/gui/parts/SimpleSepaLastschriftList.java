 ...
 */
public class SimpleSepaLastschriftList extends TablePart
{
  private final static I18N i18n = Application.getPluginLoader().getPlugin(HBCI.class).getResources().getI18N();
  
  /**
   * ct.
   * @param list die Liste der Lastschriften.
   * @throws RemoteException
   */
  public SimpleSepaLastschriftList(GenericIterator list) throws RemoteException
  {
   ...
   * @throws RemoteException
   */
  public SimpleSepaLastschriftList(List<SepaLastschrift> list) throws RemoteException
  {
    super(list,new SepaLastschriftNew());
