...
public class SepaSammelLastschriftList extends ContextMenu
{
    ...
    addItem(new NotActiveMultiMenuItem(i18n.tr("In Einzelaufträge teilen..."), new SepaSammelLastschriftSplit(),"lastschrift.png"));
    addItem(ContextMenuItem.SEPARATOR);
  ...
  private class NotActiveMultiMenuItem extends CheckedContextMenuItem
  {
    ...
    public boolean isEnabledFor(Object o)
    {
      ...
      try
      {
        ...
        for (Terminable mitTermin : (Terminable[]) o)
        {
