...
public class HBCIVariantPinTanStep2 extends AbstractHBCIAccountView
{
  ...
  public void bind() throws Exception
  {
    ...
    if (bank != null && bank.trim().length() > 0)
      c.addHeadline(i18n.tr("Schritt 4: Zugangsdaten für {0}",bank));
    else
      c.addHeadline(i18n.tr("Schritt 4: Zugangsdaten"));
    ...
    cs.addPart(control.getUsername());
    cs.addPart(control.getCustomer());
    cs.addPart(control.getPassword());
