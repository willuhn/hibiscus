/**********************************************************************
 * $Source: /cvsroot/hibiscus/hibiscus/src/de/willuhn/jameica/hbci/schedule/LastschriftScheduleProvider.java,v $
 * $Revision: 1.1 $
...
/**
 * Implementierung eines Schedule-Providers fuer offene Lastschriften.
 */
@Lifecycle(Type.REQUEST)
public class LastschriftScheduleProvider extends AbstractTransferScheduleProvider<Lastschrift>
{
  /**
...
/**********************************************************************
 * $Log: LastschriftScheduleProvider.java,v $
